...
export function BidWidget({ artworkSlug }: { artworkSlug: string }) {
    ...
    // No skeleton while loading: auctions are rare, and a non-auction piece renders
    // nothing here — a placeholder would just stack a phantom skeleton above the
    // ProductSelector's. Render nothing until an active auction is confirmed.
